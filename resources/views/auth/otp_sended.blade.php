...
<head>
    ...
    <title>{{ $setting->project_name }} | Login with OTP</title>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 col-12 d-flex flex-column justify-content-center mx-auto">
                        <div class="card card-plain">
                            ...
                            <div class="card-header pb-0 text-center">
                                <h4 class="font-weight-bolder">Login with OTP</h4>
                                <p class="mb-0">Enter your username to receive an OTP</p>
                            </div>

                            <div class="card-body">
                                <form action="{{ route('verify.otp') }}" method="POST" class="signin-form" autocomplete="off">
                                    @csrf
