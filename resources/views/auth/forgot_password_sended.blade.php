                ...
                <div class="row min-vh-100">
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-7 col-12 d-flex flex-column justify-content-center mx-auto">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form action="{{ route('student.forgot.password.verify.otp') }}" method="POST" class="signin-form" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="mb-3 text-center">
                                        <div class="d-flex justify-content-center" id="otp-box">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-end">
                                                <a href="{{ route('student.forgot.password.make') }}" class="text-sm text-secondary">Forgot password?</a>   
                                            </div>
                                        </div>
                                    </div>
                                </form>
