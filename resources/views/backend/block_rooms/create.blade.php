...
@section('title', 'Admin | Create Block Room ')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.block_room.store') }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="room_category_id" required>
                                        ...
                                        <option value="{{ $room->id }}" {{ old('room_category_id') == $room->id ? 'selected' : '' }}>{{ $room->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="blocked_room" class="form-control" placeholder="Enter No. of Blocked Rooms" value="{{ old('blocked_room') }}" required>
                                </div>
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-outline-info">Create Block Room</button>
                        </div>
                    </form>
                </div>
                <!-- /.container-fluid -->
