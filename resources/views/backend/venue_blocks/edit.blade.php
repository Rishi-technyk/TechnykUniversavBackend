...
@section('title', 'Admin | Update Venue Block')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.venue_block.update', encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="from_date" class="form-control" placeholder="Enter From Date" value="{{ old('from_date', $data->from_date) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="to_date" class="form-control" placeholder="Enter To Date" value="{{ old('to_date', $data->to_date) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Remark</label>
                                    <textarea class="form-control" name="remark" placeholder="Enter Remark">{{ old('remark', $data->remark) }}</textarea>
                                </div>
                            </div>
                            <!-- /.col -->
