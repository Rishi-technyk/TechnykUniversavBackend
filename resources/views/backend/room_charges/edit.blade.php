...
@section('title', 'Admin | Update Room Charges ')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.room_category.update', encrypt($data->id)) }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="category_id" required>
                                        ...
                                        <option value="{{ $cate->Catg_Code }}" {{ $data->category_id == $cate->Catg_Code ? 'selected' : '' }}>{{ $cate->Catg_Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="occupant_type_id" required>
                                        ...
                                        <option value="{{ $occu->id }}" {{ $data->occupant_id == $occu->id ? 'selected' : '' }}>{{ $occu->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="charges" class="form-control" min="1" placeholder="Enter Charges / Nite" value="{{ old('charges', $data->charges_nite) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_of_booked_room" class="form-control" placeholder="Enter No. Of Rooms" value="{{ old('no_of_booked_room', $data->no_of_booked_room) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="max_no_of_nites" class="form-control" placeholder="Enter Max No. Of Nites" value="{{ old('max_no_of_nites', $data->max_no_of_nites) }}" required>
                                </div>
                            </div>
                            <!-- /.col -->
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-outline-info">Update Room Charges</button>
                        </div>
                    </form>
                </div>
                <!-- /.container-fluid -->
