...
@section('title', 'Admin | Update Venue Charge ')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.venue_charge.update', encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="rate" class="form-control" placeholder="Enter Rate" value="{{ old('rate', $data->rate) }}" required>
                                </div>
                            </div>
                            <!-- /.col -->
