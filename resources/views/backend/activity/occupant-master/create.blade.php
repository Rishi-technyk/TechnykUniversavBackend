        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.activity_occupant_masters') }}" class="btn btn-outline-info btn-sm"><i class="nav-icon fas fa-arrow-left"></i> &nbsp;Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.activity_occupant_master.store') }}" method="post">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="charge" class="form-control" placeholder="Enter Charge" value="{{ old('charge') }}" required>
                                </div>
                            </div>
                            <!-- /.col -->
