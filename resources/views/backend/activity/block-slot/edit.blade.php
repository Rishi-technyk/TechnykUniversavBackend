...
@section('title', 'Admin | Update Block Slot')
        ...
        <div class="container-fluid">
            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('admin.block_slot.update', encrypt($data->id)) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" class="form-control" value="{{ old('date', $data->date) }}" placeholder="Select Date" required>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-outline-info">Update Block Slot</button>
                        </div>
                    </form>
                </div>
                <!-- /.container-fluid -->
