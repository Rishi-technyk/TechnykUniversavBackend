    ...
    $(document).ready(function() {
        ...
        */
        ...
        $(".checkout").change(function(){
            let checkOutDate = getDdMmYyyy(this.value);
            let checkInDate = getDdMmYyyy($(".checkin").val());
            console.log(checkOutDate);
            // console.log(checkInDate);
            if (checkOutDate <= checkInDate) {
                $(".checkin").val(getdmY(checkOutDate));
            }
        });

        $(".checkin").change(function(){
            let checkInDate = getDdMmYyyy(this.value);
            $(".checkout").flatpickr({
                mode: "single",
                enableTime: false,
                dateFormat: "d-m-Y",
                defaultDate: checkInDate.fp_incr(1),
                minDate: checkInDate.fp_incr(1), // add 1 day
            });
        });
