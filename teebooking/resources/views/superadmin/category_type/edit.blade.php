...
<div class="card mb-1 h-100">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('category.type.update') }}" method="Post">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter Category Type" value="{{ $data->CategoryType }}" required>
