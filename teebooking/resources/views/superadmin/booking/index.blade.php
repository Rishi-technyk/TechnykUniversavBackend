...
<div class="card mb-1 h-100 table-response">
        ...
        <form action="" method="Get" class="mb5">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 form-group mt-4">
                    ...
                    <input type="date" name="from_fundate" value="{{ $request->from_fundate }}" class="form-control" placeholder="Function Date">
                </div>

                <div class="col-lg-3 form-group">
                    <label>To Date</label>
                    <input type="date" name="to_fundate" value="{{ $request->to_fundate }}" class="form-control" placeholder="Function Date">
                </div>
