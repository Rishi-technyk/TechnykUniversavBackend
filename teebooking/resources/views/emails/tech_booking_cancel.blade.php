...
DUE TO TECHNICAL GLITCH your Tee Booking has been {{$data->booking_type}} for {{ \Carbon\Carbon::parse($data->booking_date)->format('jS F, Y')}} against booking number {{$data->bookingId}} <br>
...
Apologies for the inconvenience caused. For further details we request you to get in touch with AEPTA's Tournament Section.
