...
Your Tee Booking has been {{$data->booking_type}} for {{ \Carbon\Carbon::parse($data->booking_date)->format('jS F, Y')}} against booking number RI{{ str_pad($data->id, 8, '0', STR_PAD_LEFT) }}<br>
