...
<div style="background-color: #eee;" class="p-4">
                                    ...
                                    @for($i = 0; $i < 14; $i++) @php $timelineDate->modify("+1 day");
                                        ...
                                        <div
                                            ...
                                            <a href="javascript:void();" class="timeline-date " onClick="">
                                                <span
                                                    class="d-block"><strong>{{ strtolower($formattedDay) }}</strong></span>
                                                <span class="d-block">{{ $formattedDate }}</span>
                                            </a>
                                            @else
                                            <a href="javascript:void();" class="timeline-date "
                                                onClick="submitForm('{{$date}}')">
                                                <span
                                                    class="d-block"><strong>{{ strtolower($formattedDay) }}</strong></span>
                                                <span class="d-block">{{ $formattedDate }}</span>
                                            </a>
                            ...
                            <nav>
                                <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                    ...
                                    <button class="nav-link" id="nav-tab-3-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-tab-3" aria-controls="nav-tab-3" aria-selected="false">My
                                        Bookings</button>
                                    <button class="nav-link" id="nav-tab-2-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-tab-2" aria-controls="nav-tab-2"
                                        aria-selected="false">Group Booking </button>

                                    <button class="nav-link" id="nav-tab-4-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-tab-4" aria-controls="nav-tab-4"
                                        aria-selected="false">Manage Buddies and Favorite Four</button>
                                </div>
                            </nav>
                            <div class="tab-content py-3 border bg-light" id="nav-tabContent">
                                                ...
                                                <li
                                                    ...
                                                    <div class="udi-right">
                                                        <div class="udi-r-text">
                                                            ...
                                                            @if($is_booking_exist && $teeSheet->data->available_players
                                                            == 4 || Auth::user()->Status=="Out Station")
                                                            <p>-</p>
                                                            ...
                                                            @elseif (Auth::user()->id != $teeSheet->data->player1_id &&
                                                            $teeSheet->data->available_players==4)
                                                            <button class="btn btn-primary book-now-btn"
                                                                data-member-status="{{ Auth::user()->Status}}"
                                                                data-booking-date="{{ $teeSheet->teeBooking->booking_date }}"
                                                                data-tee-time="{{ \Carbon\Carbon::parse($teeSheet->tee_time)->format('g:iA') }}"
                                ...
                                <div class="tab-pane fade" id="nav-tab-3" aria-labelledby="nav-tab-3-tab">
                                    <div class="product-content-box">
                                        ...
                                        @foreach (App\Models\TeeBookingDetails::get_player_booking(auth()->user()->id)
                                        as $booking)
                                                    ...
                                                    <li class="cll-item">
                                                        ...
                                                        <div class="cllh-data">
                                                            <h5>
                                                                ...
                                                                1.
                                                                {{ $booking['player1_name'] }}/{{$booking['player1_member_id']}}
                                                                @else
                                                                1. Yourself
                                                                @endif
                                                            </h5>
                                                            <h4>
                                                                ...
                                                                2.
                                                                {{ $booking['player2_name'] }}/{{$booking['player2_member_id']}}
                                                                @else
                                                                2. Player 2
                                                                @endif
                                                            </h4>
                                                            <h4>
                                                                ...
                                                                3.
                                                                {{ $booking['player3_name'] }}/{{$booking['player3_member_id']}}
                                                                @else
                                                                3. Player 3
                                                                @endif
                                                            </h4>
                                                            <h4>
                                                                ...
                                                                4.
                                                                {{ $booking['player4_name'] }}/{{$booking['player4_member_id']}}
                                                                @else
                                                                4.Player 4
                                                                @endif
                                                            </h4>
                                        ...
                                        <div class="confirm-lower d-none">
                                            ...
                                            <div class="confirm-lower-right">
                                                <ul class="clr-list">
                                                    ...
                                                    <li class="clr-item"> <a href="#" class="cll-link"> <i
                                                                class="fa-solid fa-xmark" style="color: #000000;"> </i>
                                                            cancel
                                                            booking </a> </li>
                                                    <li class="clr-item"> <a href="#" class="cll-link"><i
                                                                class="fa-solid fa-print" style="color: #000000;"> </i>
                                                            print
                                                            confirmation </a> </li>
                                                </ul>
                                            </div>
    ...
    <!-- The modal structure -->
    <div class="modal loading-btn-form" id="bookNowModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    ...
                    <nav>
                        <div class="nav nav-tabs custom-nav" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="true">Tee Book</button>
                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                                aria-selected="false">Favorite 4</button>
                            <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact"
                                aria-selected="false">My Buddies</button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <form method="post" id="group_submit_form" action="{{route('store_group_booking')}}">
                                <div style="height:300px;overflow: scroll;">

                                    @csrf
                                    <input type="hidden" id="groupTeeSheetId" name="tee_sheet_id">
                                    <input type="hidden" id="groupTeeBookingId" name="tee_booking_id">
                                ...
                                <button type="submit" id="group_submit_btn" class="btn btn-primary mt-3">Submit</button>
                            </form>
                        </div>

                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <form method="post" id="buddy_submit_form" action="{{route('store_buddy_booking')}}">
                                <div style="height:300px;overflow: scroll;">

                                    @csrf
                                    <input type="hidden" id="buddyTeeSheetId" name="tee_sheet_id">
                                    <input type="hidden" id="buddyTeeBookingId" name="tee_booking_id">
                                    @foreach(\App\CPU\Helpers::get_buddy_list() as $buddy)

                                    <a href="#" class="mng-data">
                                        <div class="mng-gl-box">
                                            <input type="checkbox" class="buddy_ids" name="buddy_id[]" value="{{$buddy['member_id']}}" />
                                ...
                                <button type="submit" id="buddy_submit_btn" class="btn btn-primary mt-3">Submit</button>
                            </form>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        var maxChecked = 3; // Maximum number of checkboxes allowed to be checked
    
    $('.buddy_ids').change(function(){
        var checkedCount = $('.buddy_ids:checked').length;
        if (checkedCount >= maxChecked) {
            $('.buddy_ids:not(:checked)').prop('disabled', true);
        } else {
            $('.buddy_ids:not(:checked)').prop('disabled', false);
        }
    });
        ...
        $('.book-now-btn').click(function() {
            ...
            if (status == "Direct Out Station" || status == "In Station") {
                ...
                $('#groupTeeSheetId').val(teeSheetId);
                $('#groupTeeBookingId').val(teeBookingId);
                $('#buddyTeeSheetId').val(teeSheetId);
                $('#buddyTeeBookingId').val(teeBookingId);
        ...
        // group_submit_form
        $('#group_submit_form').submit(function(e) {
            e.preventDefault();
            var formData = $(this).serialize();
            // Submit form via AJAX
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $html = "Submit";
                    var $submitBtn = $('#group_submit_btn');
                    $submitBtn.prop('disabled', false);
                    $submitBtn.html('');
                    $submitBtn.html($html);
        ...
        // group_submit_form
        $('#buddy_submit_form').submit(function(e) {
            e.preventDefault();
            var formData = $(this).serialize();
            var checkedCount = $('.buddy_ids:checked').length;
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $html = "Submit";
                    var $submitBtn = $('#buddy_submit_btn');
                    $submitBtn.prop('disabled', false);
                    $submitBtn.html('');
                    $submitBtn.html($html);
    ...
    $(document).ready(function() {
        ...
        /*$('.player-list').change(function() {
            var selectedLabel = $(this).val();
                ...
                if (datalist) {
                    var option = Array.from(datalist.options).find(opt => opt.value === selectedLabel);
                    console.log('Option:', option);

                    var selectedId = option ? option.getAttribute('data-value') : null;
