                ...
                <div class="card mb-1 h-100">
                    <div class="card-body text-center pt-5">
                        <div class="custom--form dashboard-form mt-5">
                            <form id="changePasswordFrom" action="{{route('payment.checkout')}}"
                                method="post">
                                @csrf
                                <div class="dashboard-input mt-5">
                                    <div style="text-align: left !important;">
                                        <p>Balance as on : {{ $card_recharge?date("d-m-Y", strtotime($card_recharge->ClosingDate)):'' }} : {{ $card_recharge?$card_recharge->CardBalance:'' }}</p><br>
                                        <p>Card Recharge Amount : </p>
                                    </div>
                                    <input type="number" name="txtAmountCharged" class="form--control" placeholder="Enter Card Recharge Amount" required min="1" />
