...
class RoomBookingController extends Controller
{
    ...
    public function booking_check_availability_list(Request $request)
    {
        $member = Member::where("memberprofile.id",auth()->user()->id)->leftJoin('categorytypes', 'categorytypes.code', '=', 'memberprofile.CategoryTypeCode')->first();
        ...
        return view('website.pages.room_booking.room_availability_list',compact('member', 'request', 'rooms', 'occupant', 'SOP', 'setting', 'from_date', 'to_date', 'status', 'check_in_date_last', 'daysDifference', 'max_nitie'));
    }
    ...
    public function get_bank_terms(Request $request)
    {
        $html = view('website.pages.room_booking.get_bank_terms')->render();
