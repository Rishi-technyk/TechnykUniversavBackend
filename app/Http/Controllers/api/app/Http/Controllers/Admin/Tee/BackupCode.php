...
class TeeSheetController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $teeSheets = TeeSheet::with('teeBooking')->where('tee_booking_id', $id)->get();
        ...
        return view('admin.tee.tee_sheets.show', compact('id','teeSheets','teeHoles','teeSessions'));
    }
    ...
    $filteredMembers = $membersObj->filter(function ($member) use ($categoryCodes) {
        return in_array($member->CategoryCode, $categoryCodes);
    });
