...
class PushNotifications extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.notifications.config.index', compact('notification', 'search'));
    }
        ...
        $data = [
            "message" => [
                ...
                "notification" => [
                    ...
                    "image" => 'https://holidayclub.in/holidayclub/get-notification-image/'.$notification->image
                ],
                "data" => [
                    "type" => "Notification"
                ]
