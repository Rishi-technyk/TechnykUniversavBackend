...
class TeeSessionNameController extends Controller
{
    public function index()
    {
        ...
        return view('admin.tee.session_names.index', compact('sessionNames'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('session_names.index')->with('success', 'Session name created successfully!');
    }
    ...
    public function update(Request $request, TeeSessionName $sessionName)
    {
        ...
        return redirect()->route('session_names.index')->with('success', 'Session name updated successfully!');
    }
    ...
    public function destroy(TeeSessionName $sessionName)
    {
        ...
        return redirect()->route('session_names.index')->with('success', 'Session name deleted successfully!');
    }
}
